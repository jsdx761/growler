...
public class DS1VolumeActivity extends DS1ServiceActivity {
  ...
  protected void onCreate(Bundle b) {
    ...
    // AlertsActivity maintains the BLE connection; we just need the service
    // reference to read/write volume settings.
    bindDS1ServiceOnly(() -> {
      Log.i(TAG, "bindDS1ServiceOnly.onDone");
    });
  ...
  protected void onDestroy() {
    ...
    // We used bindDS1ServiceOnly, so skip BLE disconnect on destroy
    mServiceOnly = true;
    super.onDestroy();
  }

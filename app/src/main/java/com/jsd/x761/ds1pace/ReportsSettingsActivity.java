...
/**
 * An activity that configures the Waze reports feature preferences.
 */
public class ReportsSettingsActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle b) {
    ...
    toolbar.setTitle("Waze Alerts");
    toolbar.setNavigationOnClickListener(v -> getOnBackPressedDispatcher().onBackPressed());
    CompoundButton useReportsSwitch = findViewById(R.id.useReportsSwitch);
    EditText reportsURLEdit = findViewById(R.id.reportsURLEdit);

    // Retrieve the Waze reports preferences
    ...
    reportsURLEdit.addTextChangedListener(new TextWatcher() {
      ...
      public void afterTextChanged(Editable s) {
        ...
        // Save the Waze reports server URL preference
        SharedPreferences.Editor editor = mSharedPreferences.edit();
    ...
    String reportsAPIKey = securePrefs.getString(getString(R.string.key_reports_api_key),
    ...
    reportsEnvEdit.addTextChangedListener(new TextWatcher() {
      ...
      public void afterTextChanged(Editable s) {
        Log.i(TAG, String.format("afterTextChanged %s", s.toString()));
        // Save the Waze reports region preference
        SharedPreferences.Editor editor = mSharedPreferences.edit();

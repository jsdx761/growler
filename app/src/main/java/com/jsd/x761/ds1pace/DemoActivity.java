...
public class DemoActivity extends AppCompatActivity {
  ...
  private void runRadarDemo() {
    ...
    sendBroadcast(new Intent("com.jsd.x761.ds1pace.SIMULATE_RADAR_CLEAR"));

    // Send a variety of radar alerts with staggered timing
    mHandler.postDelayed(() -> {
      Intent i = new Intent("com.jsd.x761.ds1pace.SIMULATE_RADAR");
      i.putExtra("band", "KA");
    ...
    mHandler.postDelayed(() -> {
      Intent i = new Intent("com.jsd.x761.ds1pace.SIMULATE_RADAR");
      i.putExtra("band", "Laser");
      i.putExtra("intensity", 100.0f);
      i.putExtra("distance", 0.2f);
      i.putExtra("bearing", 12);
      sendBroadcast(i);
    }, 9000);
    ...
    mHandler.postDelayed(() -> {
      Intent i = new Intent("com.jsd.x761.ds1pace.SIMULATE_RADAR");
      i.putExtra("band", "Red Light Cam");
      i.putExtra("distance", 0.4f);
      i.putExtra("bearing", 1);
      sendBroadcast(i);
    }, 12000);
  ...
  private void runCrowdSourcedDemo() {
    ...
    sendBroadcast(new Intent("com.jsd.x761.ds1pace.SIMULATE_REPORT_CLEAR"));

    mHandler.postDelayed(() -> {
      Intent i = new Intent("com.jsd.x761.ds1pace.SIMULATE_REPORT");
  ...
  private void runAircraftDemo() {
    ...
    sendBroadcast(new Intent("com.jsd.x761.ds1pace.SIMULATE_AIRCRAFT_CLEAR"));

    mHandler.postDelayed(() -> {
      Intent i = new Intent("com.jsd.x761.ds1pace.SIMULATE_AIRCRAFT");

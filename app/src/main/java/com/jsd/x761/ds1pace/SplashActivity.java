...
public class SplashActivity extends AppCompatActivity {
  ...
  protected void checkFineLocationPermission() {
    ...
    if(this.checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
      runOnUiThread(() -> {
        ...
        b.setMessage("Please allow DS1-Pace to access this device's precise location.\n\n" +
          "This will be needed to be able to look for Waze alerts and aircrafts close to your location.");
  ...
  protected void checkBackgroundLocationPermission() {
    ...
    if(this.checkSelfPermission(Manifest.permission.ACCESS_BACKGROUND_LOCATION) != PackageManager.PERMISSION_GRANTED) {
      runOnUiThread(() -> {
        AlertDialog.Builder b = new AlertDialog.Builder(SplashActivity.this);
        b.setMessage("Please also allow DS1-Pace to access your location all the time.\n\n" +
  ...
  protected void checkBluetoothScanPermission() {
    ...
    if(this.checkSelfPermission(Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
      runOnUiThread(() -> {
        AlertDialog.Builder b = new AlertDialog.Builder(SplashActivity.this);
        b.setMessage("Please allow DS1-Pace to find and connect to nearby devices.\n\nThis will be needed to find and connect to your DS1 radar detector.");
  ...
  protected void checkBluetoothConnectPermission() {
    ...
    if(this.checkSelfPermission(Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
      runOnUiThread(() -> {
        AlertDialog.Builder b = new AlertDialog.Builder(SplashActivity.this);
        b.setMessage("Please allow DS1-Pace to connect to Bluetooth devices.\n\nThis will be needed to connect to your DS1 radar detector.");

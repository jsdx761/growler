...
public class Configuration {
  ...
  // Found by Optuna optimization (150 trials, score 0.6845).
  ...
  public static final float TUNED_LOCAL_RATE = 0.65f;
  public static final String TUNED_LOCAL_FILTER =
    "6.0,300.0,-5.5,850.0,1.5,-5.0,3900.0,1.0,-6.0,7750.0,-22.0,2.0";
  ...
  public static final int REPORTS_CHECK_RETRY_COUNT = 1;
